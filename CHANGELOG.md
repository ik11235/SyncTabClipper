...
- [DEV] service worker のバンドルから読み取り専用の zlib を外し、起動時に読み込むコードを 67KB → 11KB に削減 (v1/v2 の解凍は tabs ページで必要になったときだけ動的に読み込む。base64 の復号を `buffer` ポリフィルから `atob` へ変更) (#237, #272)
